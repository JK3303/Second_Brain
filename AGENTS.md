# Second_Brain Agent Instructions
...
- For Agent Memory / OpenClaw launch work, the parent issue is `NAT-833`. Record architecture notes, implementation milestones, blockers, and verification results there.
...
- Keep Agent Memory runtime-neutral. OpenClaw is the flagship launch runtime, not the product boundary.
...
- Carry Nate B. Jones / Open Brain provenance through product surfaces, docs, diagrams, screenshots, and starter seed data. Keep it subtle and useful: micro-branding, source labels, logo marks, and provenance language instead of loud marketing copy.
